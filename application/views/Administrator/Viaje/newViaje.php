<form id="newViaje" method="post" action="../viaje/storeNewViaje">
	<fieldset>
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" name="nameViaje" class="form-control" placeholder="Nombre Empresa"/>            
        </div>
        </div>
        ...
        <input type="button" class="btn btn-primary" value="Nuevo Viaje" id="newBtnViaje" name="newBtnViaje"/>
