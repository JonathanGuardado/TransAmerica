<form id="searchFormCabezal" method="post" action="cabezal/searchCabezal2">
	<fieldset>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 form-group"  style="text-align:left"><input type="text" name="nameCabezal" data-controller="cabezal" data-method="getData" class="form-control autocomplete" placeholder="No. Cabezal"/>            
        </div>
