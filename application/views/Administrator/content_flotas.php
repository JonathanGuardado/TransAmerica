<div class="row">
	<div id="listgroup" class="col-lg-2" style="margin-top:60px">
		<div class="list-group accordion" id="accordion">
			<div class="accordion-group">
				<div class="accordion-heading">
		  		<a id="Unit" class="list-group-item accordion-toogle" data-toggle="collapse" data-parent="#accordion" href="#collapseUnit">Unidad</a>
				</div>
			...
			<div class="accordion-body collapse" id="collapseChofer">
		  	...
		  	<div class="accordion-group">
				<div class="accordion-heading">
		  		<a id="Chasis" class="list-group-item accordion-toogle" data-toggle="collapse" data-parent="#accordion" href="#collapseChasis">Chasis</a>
				</div>
			<div class="accordion-body collapse" id="collapseChasis">
		  	...
		  	<div class="accordion-group">
				<div class="accordion-heading">
		  		<a id="Contenedor" class="list-group-item accordion-toogle" data-toggle="collapse" data-parent="#accordion" href="#collapseContenedor">Contenedor</a>
				</div>
	...
	<div id="content_flotas" class="col-lg-10">
		<h1>Flota</h1>
	</div>
</div>
