<form id="editLugarForm" method="post" action="lugar/storeEditLugar">
	<fieldset>
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" value="<?php echo $nombre; ?>" name="nombreLugar" class="form-control" placeholder="Nombre Lugar"/>            
        </div>
        </div>
        <div class="row" style="margin-top: 10px;">
        <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs"  style="text-align:right"><label>Ciudad</label></div>
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" value="<?php echo $ciudad; ?>" class="form-control" name="ciudad" placeholder="Ciudad" />
        </div>
        </div>
        <div class="row" style="margin-top: 10px;">
        <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs"  style="text-align:right"><label>Pa&iacute;s</label></div>
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" value="<?php echo $pais; ?>" class="form-control" name="pais" placeholder="Pa&iacute;s" />
        </div>
        </div>
        ...
        <input type="button" class="btn btn-primary sendBtn" value="Editar Lugar" id="editBtnLugar" name="editBtnLugar"/>
            ...
            <br />            
            <input type="hidden" name="idlugar" id="idlugar" value="<?php echo $idlugar; ?>"/>
        </div>
	</fieldset>
</form>
