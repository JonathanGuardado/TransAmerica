<form method="post" action="unit/editUnit2" id="buscarUnitForm">
	<fieldset>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 form-group"  style="text-align:left"><input type="text" name="nameUnit"  data-controller="unit" data-method="getData" class="form-control autocomplete" required placeholder="No. Unidad"/>            
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        <input type="button" class="btn btn-primary sendBtn" value="Buscar Unidad" name="newUnit" id="buscarBtnUnit"/>            
        </div>
        </div>        
