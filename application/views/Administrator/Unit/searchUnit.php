<form id="searchFormUnit" method="post" action="unit/searchUnit2">
	<fieldset>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 form-group"  style="text-align:left"><input type="text" name="nameUnit" class="form-control" required placeholder="No. Unidad"/>            
        </div>
