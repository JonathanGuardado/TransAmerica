<form id="newFormAsignacion" method="post" action="asignacion/storeNewAsignacion">
	<fieldset>
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" data-controller="unit" data-method="getData" class="form-control autocomplete" name="noUnit" placeholder="No. Unidad" />
        </div>
        </div>
        <div class="row" style="margin-top: 10px;">
        <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs"  style="text-align:right"><label>No. Llanta</label></div>
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" data-controller="asignacion" data-method="getDataWheels" class="form-control autocomplete" name="noWheel" placeholder="No. Llanta" />
        </div>
        </div>
        <div class="row" style="margin-top: 10px;">
