<form id="editChasisForm" method="post" action="chasis/storeEditChasis">
	<fieldset>
        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12"  style="text-align:left"><input type="text" class="form-control" name="marca" placeholder="Marca" value="<?php echo $idplaca ?>" />
        </div>
        </div>
        <div class="row" style="margin-top: 10px;">
