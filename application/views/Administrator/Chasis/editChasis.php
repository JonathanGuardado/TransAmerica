<form method="post" action="chasis/editChasis2" id="buscarFormChasis">
	<fieldset>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 form-group"  style="text-align:left"><input type="text" name="nameChasis" data="getData" class="form-control autocomplete" placeholder="No. Chasis"/>            
        </div>
